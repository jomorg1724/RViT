...
QA_ROOT = VDA_ROOT / "qa"
SNAPSHOT_ROOT = VDA_ROOT / "review_snapshots" / "final_candidate_20260712_v8"
...
def validate_final_reviews(source_sha: str, pdf_sha: str, snapshot_sha: str) -> dict:
    ...
    for role, verdict in required_verdicts.items():
        ...
        expected_path = relative(QA_ROOT / f"2026-07-12_final_review_{role}.json")
        ...
        expected_artifact_sha = sha256(v15_manifest) if role == "artifact" else None
...
def main() -> None:
    ...
    artifacts = [
        ...
        REVIEW_ATTESTATIONS,
        QA_ROOT / "2026-07-12_final_review_feynman.json",
        QA_ROOT / "2026-07-12_final_review_hawking.json",
        QA_ROOT / "2026-07-12_final_review_tyson.json",
        QA_ROOT / "2026-07-12_final_review_thorne.json",
        QA_ROOT / "2026-07-12_final_review_prose.json",
        QA_ROOT / "2026-07-12_final_review_artifact.json",
        SNAPSHOT_MANIFEST,
