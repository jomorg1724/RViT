...
cp "$PROJECT_ROOT/tests/test_modern_critic_dominant_experiment_contract.py" "$RUN_ROOT/provenance/source_snapshot/tests/test_modern_critic_dominant_experiment_contract.py"
sha256sum \
  ...
  "$PROJECT_ROOT/tests/test_modern_critic_dominant_experiment_contract.py" \
...
{
  printf 'experiment=vda4_modern_gamma095_critic1_actor01_jepa0001_teacher003005_nobc_seed0_v1\n'
  printf 'hypothesis=critic_dominant_objective_stabilizes_value_grounding_then_actor_then_JEPA\n'
  printf 'objective_hierarchy=critic_1.0_gt_actor_0.1_gt_jepa_0.001__bc_alpha_0.0\n'
  printf 'run_root=%s\n' "$RUN_ROOT"
  printf 'iterations=%s\n' "$ITERS"
