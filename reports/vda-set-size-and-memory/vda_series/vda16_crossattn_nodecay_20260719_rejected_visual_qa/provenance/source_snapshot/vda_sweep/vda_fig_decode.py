...
cued versus uncued changes for VDA2/VDA4/VDA9/VDA16. VDA1 has no uncued
location, so its change-location decode is explicitly undefined (NaN).
"""
...
TASK_MIN_N = {
    ...
    "vda4": 48,
    "vda9": 128,
    # At n=256, the 128 change trials split into 64 cued and 64 uncued
    # examples. Round-robin allocation gives each of VDA16's 15 uncued
    # location classes at least four samples, the minimum support for CV=4.
    "vda16": 256,
}
