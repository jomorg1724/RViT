"""
RViTPlusV11Part2Model — conv-free, RL-only recurrent attention model with PARALLEL
...
trainer, hyperparameters — unchanged). v11_part2 changes vs v11:

  1. ENCODER (DualStreamEncoder), SINGLE head each:
       • Tμ SALIENCE:  Q=X, K=V=[H1 ‖ H2], residual=X → Z_sal  (v11_part2 adds H2 to
...
class RViTPlusV11Part2Model(nn.Module):
