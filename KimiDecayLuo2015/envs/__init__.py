...
try:
    ...
    from .tasks import (Validity4Env, VDAEnv, VDA9Env, SetSizeEnv, LuoMaunsellEnv, KrauzlisEnv, VDAExclusionEnv, VDASetSizeEnv, FixedGridVDASetSizeEnv, DelayProbeEnv, MotionZKEnv)
    ...
    from tasks import (Validity4Env, VDAEnv, VDA9Env, SetSizeEnv, LuoMaunsellEnv, KrauzlisEnv, VDAExclusionEnv, VDASetSizeEnv, FixedGridVDASetSizeEnv, DelayProbeEnv, MotionZKEnv)  # type: ignore
...
TASKS = {
    ...
    "motion_zk":    dict(make=lambda **k: MotionZKEnv(**k),                grid=(2, 2)),   # Zénon-Krauzlis motion DMC (2 diagonal moving-dot patches, go/no-go)
...
__all__ = ["TASKS", "make_env", "task_grid", "BaseChangeDetectionEnv",
           ...
           "VDAExclusionEnv", "VDASetSizeEnv", "FixedGridVDASetSizeEnv", "DelayProbeEnv", "MotionZKEnv"]
