"""
RViTPlusSetsize9BroadcastModel — conv-free, RL-only recurrent attention model with PARALLEL
...
trainer, hyperparameters — unchanged). setsize9_broadcast changes vs v11:

  1. ENCODER (DualStreamEncoder), SINGLE head each:
       • Tμ SALIENCE:  Q=X, K=V=[H1 ‖ H2], residual=X → Z_sal  (setsize9_broadcast adds H2 to
...
class RViTPlusSetsize9BroadcastModel(nn.Module):
