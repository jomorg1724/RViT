"""First-wave VDA4/VDA9/VDA16 figure specifications and deterministic pipelines.
...
occupied 3x3 display. The current VDA16 run is a fully occupied 4x4 display.
Compute functions write NPZ/JSON evidence; plot functions consume only those
caches.
"""
...
FIRST_WAVE_TASKS = ("vda4", "vda9", "vda16")
...
_SPECS = {
    ...
    "vda16": FirstWaveSpec("vda16", (4, 4), 100, 16, tuple(range(16)), 0, 15),
}
