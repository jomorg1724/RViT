...
Run:  .venv/bin/python -m RViT_plus_v11.tests.test_v11
"""
...
from RViT_plus_v11.tx_lstm_encoder import DualStreamEncoder
from RViT_plus_v11.model import RViTPlusV11Model
from RViT_plus_v11.ppo import (
...
def _model(**over):
    ...
    kw.update(over)
    return RViTPlusV11Model(**kw).to(DEVICE)
