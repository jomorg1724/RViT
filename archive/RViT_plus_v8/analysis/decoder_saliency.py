...
Usage:
    .venv/bin/python RViT_plus_v8/analysis/decoder_saliency.py \
...
from RViT_plus_v8.analysis import _behav_utils as bu
from RViT_plus_v8.analysis.avg_attention_maps import (
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--checkpoint", default="RViT_plus_v8/checkpoints/rvit_plus_rl_latest.pt")
    ap.add_argument("--config", default=None)
    ap.add_argument("--out-dir", default="RViT_plus_v8/analysis/figures_decoder")
    ...
    for cond in args.conditions:
        ...
        from RViT_plus_v8.analysis.avg_attention_maps import quad_aggregate
