"""RViT+ v11_part2 — PARALLEL DUAL-STREAM attention with a SPLIT readout, single head
...
H2=LSTM2(Z_sal). v11_part2 changes vs v11: H2 added to the salience K/V, split
