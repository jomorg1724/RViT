"""RViT+ v11_part3_broadcast — PARALLEL DUAL-STREAM attention with a SPLIT readout, single head
each. v11_part3_broadcast is v11_part2 with the readout destinations SWAPPED: TQ TOP-DOWN (Q=X,
...
__all__ = [
    ...
    "DualStreamEncoder",
    "PatchEmbed",
    "RViTPlusV11Part3BroadcastModel",
]
