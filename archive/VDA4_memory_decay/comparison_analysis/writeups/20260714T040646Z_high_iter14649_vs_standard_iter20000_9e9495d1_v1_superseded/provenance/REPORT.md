...
The hypothesis is **contradicted for this frozen checkpoint pair** under the prespecified activity metric. Mean frame-to-frame total variation was 0.5245 for the standard model and 0.4249 for the high-decay model. The paired high-minus-standard difference was -0.0995 (95% bootstrap CI -0.1021 to -0.0970; n=256 matched event trials).
...
|---|---:|---:|
| attention motion, valid | -0.0981 | [-0.1014, -0.0948] |
| attention motion, forced invalid | -0.1009 | [-0.1044, -0.0974] |
| selectivity | +0.0221 | [+0.0193, +0.0247] |
| peak-key mass | -0.0374 | [-0.0409, -0.0339] |
| image-key mass | -0.0420 | [-0.0427, -0.0412] |
| valid change reorientation, t5−t4 | +0.0064 | [-0.0032, +0.0159] |
| invalid change reorientation, t5−t4 | -0.0011 | [-0.0074, +0.0049] |

At the matched psychometric anchor (100% displayed cue, Δ=15°, 300 trials/point), standard response rates were 0.667 valid and 0.373 forced invalid; high-decay rates were 0.660 valid and 0.443 forced invalid.

## Design

- Event attention: 256 matched valid and forced-invalid trials, identical latent videos through t4, change at t5.
- No-change attention: 128 trials at 25%, 50%, 75%, and 100% displayed cue proportions.
- Psychometrics: 300 shared trials at each of 4 displayed cue proportions × 10 magnitudes × 2 change locations.
