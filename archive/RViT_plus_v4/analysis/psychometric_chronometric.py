...
Usage:
    .venv/bin/python RViT_plus_v4/analysis/psychometric_chronometric.py \
        --checkpoint RViT_plus_v4/checkpoints/rvit_plus_rl_latest.pt \
...
from RViT_plus_v4.analysis import _behav_utils as bu
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--checkpoint", default="RViT_plus_v4/checkpoints/rvit_plus_rl_latest.pt")
    ap.add_argument("--config", default=None)
    ap.add_argument("--out-dir", default="RViT_plus_v4/analysis/figures")
