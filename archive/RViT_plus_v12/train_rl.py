...
Usage:
    .venv/bin/python RViT_plus_v12/train_rl.py
    .venv/bin/python RViT_plus_v12/train_rl.py --iters 500 --patch-size 5
"""
...
from RViT_plus_v12.config.loader import (
...
from RViT_plus_v12.ppo import PPOConfig, train
...
def main(argv=None) -> int:
    ...
    model = RViTPlusV12Model(**model_kwargs).to(device)
    ...
    final_path = os.path.join(args.checkpoint_dir, "rvit_plus_v12_rl_final.pt")
