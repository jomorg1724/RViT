...
COND=[(0.25,0,f"Cue25 chg-{C.SLO}","tab:blue"),(1.0,0,f"Cue100 chg-{C.SLO}","tab:green"),
      (0.25,C.CUES[-1],f"Cue25 chg-{C.SHI}","tab:orange"),(1.0,C.CUES[-1],f"Cue100 chg-{C.SHI}","tab:red")]
