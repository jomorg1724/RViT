"""
RViTPlusV11Part3Model — conv-free, RL-only recurrent attention model with PARALLEL
DUAL-STREAM attention and a SPLIT readout. v11_part3 is v11_part2 with the readout
...
class RViTPlusV11Part3Model(nn.Module):
    ...
    def _run_heads(
        ...
        # SPLIT readout (v11_part3 SWAPS v11_part2): rec = [Z_sal, Z_td].
