...
Usage:
  .venv/bin/python -m RViT_plus_v5_part2.analysis.deepdive.exp3_latent_decoding \
...
from RViT_plus_v5_part2.analysis import _behav_utils as bu  # noqa: E402,F401
from RViT_plus_v5_part2.analysis.deepdive import dd_core as dd  # noqa: E402
...
def main(argv=None):
    ...
    cp_lats = ["h1_mean", "h2_mean", "actor_cls", "critic_press_cls"]
    ...
    fig.suptitle(f"Temporal linear decoding of task variables from v5_part2 latents  ·  n={B} trials  ·  iter={it}", y=1.0)
    ...
    cl_sources = ["h1_mean", "h2_mean", "h1_quad", "h2_quad", "actor_cls", "critic_press_cls"]
