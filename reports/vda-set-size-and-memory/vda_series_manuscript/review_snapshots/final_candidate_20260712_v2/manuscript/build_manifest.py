...
def main() -> None:
    ...
    artifacts = [
        ...
        ROOT / "reports" / "vda_series" / "qa" / "2026-07-12_integrated_prose_trigger_lint.txt",
        ROOT / "reports" / "vda_series" / "qa" / "2026-07-12_integrated_prose_trigger_disposition.md",
        ...
        ROOT / "reports" / "vda_series" / "review_snapshots" / "final_candidate_20260712_v2" / "SNAPSHOT_MANIFEST.json",
