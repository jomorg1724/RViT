    ...
    *,
    ...
    for feedback in ("affine_ew", "crossattn1"):
        ...
        for axis, key in zip(
            ...
            if feedback == "crossattn1" and np.isfinite(values[key][3]):
                axis.scatter(
                    [set_sizes[3]],
                    [values[key][3]],
                    s=72,
                    ...
                    linewidths=1.8,
                    label=f"VDA16 cross-attention ({vda16_competence_status})",
                    zorder=5,
                )
    titles = (
    ...
    figure.suptitle(
        ...
        f"Open VDA16 marker is unconnected and {vda16_competence_status} "
        f"(curriculum remained at θ={vda16_final_theta:.1f}°)",
        fontweight="bold",
    )
    figure.text(
        0.5,
