...
from RViT_plus_jump.analysis.avg_attention_maps import CHANGE_LABEL, plot_head_alpha, plot_head_strip
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out-dir", default="RViT_plus_jump/analysis/figures_memkeys")
