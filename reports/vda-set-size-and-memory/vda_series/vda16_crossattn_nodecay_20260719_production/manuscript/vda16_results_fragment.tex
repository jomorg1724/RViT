\subsection{VDA16 cross-attention checkpoint}
...
qualifying response rates were 0.653 for valid and
0.133 for forced-invalid changes
($\Delta=+0.520$). These are finite-trial estimates
...
\begin{figure*}[t]
  ...
  remained at $\theta=65.0^\circ$. VDA16
