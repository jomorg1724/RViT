...
cmd=("$PYTHON_BIN" -u train_rl.py --T 7
 ...
 --experiment-launcher experiments/luo2015_episodic/fresh_grid2_memnoise0075_gamma100_reward_matrix_runpod/launch_cell.sh
...
mkdir -p "$RUN_ROOT"
cp experiments/luo2015_episodic/fresh_grid2_memnoise0075_gamma100_reward_matrix_runpod/experiment_manifest.json "$RUN_ROOT/experiment_manifest.json"
