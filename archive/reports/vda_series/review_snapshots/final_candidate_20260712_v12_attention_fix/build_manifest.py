...
QA_ROOT = VDA_ROOT / "qa"
SNAPSHOT_ROOT = VDA_ROOT / "review_snapshots" / "final_candidate_20260712_v12_attention_fix"
SNAPSHOT_MANIFEST = SNAPSHOT_ROOT / "SNAPSHOT_MANIFEST.json"
VISUAL_QA = QA_ROOT / "2026-07-12_attention_fix_v12_integrated_manuscript_visual_audit.md"
REVIEW_PREFIX = "2026-07-12_attention_fix_v12_final_review"
...
def validate_visual_qa(source_sha: str, pdf_sha: str, page_count: int, render_digest: str) -> None:
    ...
    required = [
        ...
        f"Ordered render-set SHA-256: `{render_digest}`",
        f"The rendered {page_count}-page",
    ]
...
def main() -> None:
    ...
    artifacts = [
        ...
        VISUAL_QA,
        QA_ROOT / "2026-07-12_attention_fix_v12_266_test_gate.txt",
        QA_ROOT / "2026-07-12_attention_fix_production_audit.md",
        QA_ROOT / "2026-07-12_attention_fix_v12_prose_trigger_lint.txt",
        QA_ROOT / "2026-07-12_attention_fix_v12_prose_trigger_disposition.md",
