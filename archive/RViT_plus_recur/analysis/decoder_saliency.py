...
Usage:
    .venv/bin/python RViT_plus_recur/analysis/decoder_saliency.py \
...
from RViT_plus_recur.analysis.avg_attention_maps import (
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out-dir", default="RViT_plus_recur/analysis/figures_decoder")
    ...
    for cond in args.conditions:
        ...
        from RViT_plus_recur.analysis.avg_attention_maps import quad_aggregate
