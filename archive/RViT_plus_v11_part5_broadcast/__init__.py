"""RViT+ v11_part5_broadcast — PARALLEL DUAL-STREAM attention with a SPLIT readout, single head
...
H2=LSTM2(Z_sal). v11_part5_broadcast changes vs v11: H2 added to the salience K/V, split
...
__all__ = [
    ...
    "DualStreamEncoder",
    "PatchEmbed",
    "RViTPlusV11Part5BroadcastModel",
]
