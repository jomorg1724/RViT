...
Usage:
    .venv/bin/python RViT_plus_v5_part2/analysis/psychometric_chronometric.py \
        --checkpoint RViT_plus_v5_part2/checkpoints/rvit_plus_rl_latest.pt \
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out-dir", default="RViT_plus_v5_part2/analysis/figures")
