...
QA_ROOT = VDA_ROOT / "qa"
SNAPSHOT_ROOT = VDA_ROOT / "review_snapshots" / "final_candidate_20260712_v9_attention_fix"
SNAPSHOT_MANIFEST = SNAPSHOT_ROOT / "SNAPSHOT_MANIFEST.json"
VISUAL_QA = QA_ROOT / "2026-07-12_attention_fix_integrated_manuscript_visual_audit.md"
REVIEW_PREFIX = "2026-07-12_attention_fix_final_review"
...
def main() -> None:
    ...
    artifacts = [
        ...
        VISUAL_QA,
        QA_ROOT / "2026-07-12_attention_fix_265_test_gate.txt",
