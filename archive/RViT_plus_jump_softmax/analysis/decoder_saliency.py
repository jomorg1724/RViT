...
Usage:
    .venv/bin/python RViT_plus_jump_softmax/analysis/decoder_saliency.py \
...
from RViT_plus_jump_softmax.analysis.avg_attention_maps import (
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out-dir", default="RViT_plus_jump_softmax/analysis/figures_decoder")
    ...
    for cond in args.conditions:
        ...
        from RViT_plus_jump_softmax.analysis.avg_attention_maps import quad_aggregate
