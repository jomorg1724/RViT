"""
RViTPlusV11Part4BroadcastModel — conv-free, RL-only recurrent attention model with TWO
...
trainer, hyperparameters — unchanged). v11_part4_broadcast CUTS the cross-talk v11_part2 had
...
class RViTPlusV11Part4BroadcastModel(nn.Module):
