...
Run:  .venv/bin/python -m RViT_plus_recur.tests.test_v11
"""
...
from RViT_plus_recur.tx_lstm_encoder import DualStreamEncoder
from RViT_plus_recur.model import RViTPlusRecurModel
from RViT_plus_recur.ppo import (
...
def _model(**over):
    ...
    kw.update(over)
    return RViTPlusRecurModel(**kw).to(DEVICE)
