...
Usage:
    .venv/bin/python RViT_plus_setsize9_broadcast/train_rl.py
    .venv/bin/python RViT_plus_setsize9_broadcast/train_rl.py --iters 500 --patch-size 5
"""
...
from RViT_plus_setsize9_broadcast.config.loader import (
    DEFAULT_CONFIG_PATH, cfg_get, load_checkpoint_weights, load_config,
    print_resolved_config,
)
from RViT_plus_setsize9_broadcast.env import ChangeDetectionEnv
from RViT_plus_setsize9_broadcast.model import RViTPlusSetsize9BroadcastModel
from RViT_plus_setsize9_broadcast.ppo import PPOConfig, train
...
def main(argv=None) -> int:
    ...
    model = RViTPlusSetsize9BroadcastModel(**model_kwargs).to(device)
    ...
    final_path = os.path.join(args.checkpoint_dir, "rvit_plus_setsize9_broadcast_rl_final.pt")
