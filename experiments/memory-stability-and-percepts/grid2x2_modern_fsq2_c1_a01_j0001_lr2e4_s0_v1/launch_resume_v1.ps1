# Resume launcher for vda4_modern_fsq2_c1_a01_j0001_lr2e4_s0_v1
# Continues the killed prod run (killed at iter 2436, 2026-08-17 21:56) through
# the original 20,000-iteration contract (schedule_final_iteration = 19999).
# Faithful to launch_local_v1.sh TRAIN_ARGS; only init mode / paths / iters change.
param(
  [string]$RUN_ROOT = "C:\Users\jomor\Documents\RViT_runs\vda4_fsq2_c1_a01_j0001_lr2e4_s0_v1_prod_resume_20260819",
  [string]$PYTHON_BIN = "C:\Python310\python.exe",
  [int]$ITERS = 17600
)
$ErrorActionPreference = "Continue"
$scheduleFinal = 19999
$parentCkpt = "C:\Users\jomor\Documents\RViT_runs\vda4_fsq2_c1_a01_j0001_lr2e4_s0_v1_prod_20260817\rvit_plus_rl_latest.pt"
...
# Resume contract requires producer_sha256 byte-identity with the parent checkpoint;
# the checkpoint recorded the ORIGINAL launch_local_v1.sh, so that file must stay
# the recorded --experiment-launcher even though this ps1 drives the invocation.
...
$hashLines += ("{0}  {1}" -f (Get-FileHash "$expDir\design_manifest.json" -Algorithm SHA256).Hash, "design_manifest.json") | Where-Object { Test-Path "$expDir\design_manifest.json" }
$hashLines += ("{0}  {1}" -f (Get-FileHash $launcher -Algorithm SHA256).Hash, "launch_local_v1.sh") | Where-Object { Test-Path $launcher }
$hashLines | Sort-Object | Set-Content "$RUN_ROOT\provenance_sha256.txt"

@"
experiment=vda4_modern_fsq2_c1_a01_j0001_lr2e4_s0_v1 (RESUME)
parent_run_root=C:/Users/jomor/Documents/RViT_runs/vda4_fsq2_c1_a01_j0001_lr2e4_s0_v1_prod_20260817
parent_killed_iter=2436
resume_mode=stateful (replay-excluded trainer state, schema-v3)
hypothesis=binary_FSQ_memory_tokens_discretize_representations_stabilize_actor_critic
fsq_levels=2
