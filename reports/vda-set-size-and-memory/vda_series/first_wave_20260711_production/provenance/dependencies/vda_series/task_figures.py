...
_TASK_SPECS = {
    ...
    "vda16": TaskSpec("vda16", (4, 4), 100, 16, 16, "archived_including_cue", "historical"),
...
def realized_target_distribution(
    ...
    Controlled fixed-grid tasks draw the invalid branch only from non-cued active
    items, making displayed and realized validity equal.
    """
