"""
Encoder cross-attention MEMORY-key spatial maps for RViT+ v7.

`avg_attention_maps.py` maps where the patch QUERIES attend among the PATCH keys
— but in v7 only ~10% of the cross-attention budget lands on patch keys;
...
from RViT_plus_v7.analysis.avg_attention_maps import CHANGE_LABEL, plot_head_alpha, plot_head_strip
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out-dir", default="RViT_plus_v7/analysis/figures_memkeys")
