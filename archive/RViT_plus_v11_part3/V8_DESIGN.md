...
```bash
.venv/bin/python -m RViT_plus_v9.tests.test_v8        # 13 tests (incl. the no-bypass proof)
.venv/bin/python RViT_plus_v9/train_rl.py             # train (config → ~/rvit_plus_checkpoints/v8)
```
