...
Usage:
    .venv/bin/python RViT_plus_v9/train_rl.py
    .venv/bin/python RViT_plus_v9/train_rl.py --iters 500 --patch-size 5
"""
...
from RViT_plus_v9.config.loader import (
...
from RViT_plus_v9.ppo import PPOConfig, train
...
def main(argv=None) -> int:
    ...
    model = RViTPlusV9Model(**model_kwargs).to(device)
