...
from RViT_plus_jump_softmax.analysis.avg_attention_maps import CHANGE_LABEL, plot_head_alpha, plot_head_strip
...
def mem_map_rollout(model, envs, obs0, device, which: str):
    ...
    off = N                                   # v9: only H2 is a key bank, at [N:2N]
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out-dir", default="RViT_plus_jump_softmax/analysis/figures_memkeys")
    ...
    for which in ("H2",):                     # v9: H1 is the query, not a key
