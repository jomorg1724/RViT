...
Usage:
    .venv/bin/python RViT_plus_v11_part2_broadcast/train_rl.py
    .venv/bin/python RViT_plus_v11_part2_broadcast/train_rl.py --iters 500 --patch-size 5
"""
...
from RViT_plus_v11_part2_broadcast.config.loader import (
...
from RViT_plus_v11_part2_broadcast.model import RViTPlusV11Part2BroadcastModel
...
def main(argv=None) -> int:
    ...
    model = RViTPlusV11Part2BroadcastModel(**model_kwargs).to(device)
    ...
    final_path = os.path.join(args.checkpoint_dir, "rvit_plus_v11_part2_broadcast_rl_final.pt")
