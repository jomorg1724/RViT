"""RViT+ v11_part2_broadcast — PARALLEL DUAL-STREAM attention with a SPLIT readout, single head
...
H2=LSTM2(Z_sal). v11_part2_broadcast changes vs v11: H2 added to the salience K/V, split
...
__all__ = [
    ...
    "DualStreamEncoder",
    "PatchEmbed",
    "RViTPlusV11Part2BroadcastModel",
]
