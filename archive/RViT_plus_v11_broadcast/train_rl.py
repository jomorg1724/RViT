...
Usage:
    .venv/bin/python RViT_plus_v11_broadcast/train_rl.py
    .venv/bin/python RViT_plus_v11_broadcast/train_rl.py --iters 500 --patch-size 5
"""
...
from RViT_plus_v11_broadcast.config.loader import (
    DEFAULT_CONFIG_PATH, cfg_get, load_checkpoint_weights, load_config,
    print_resolved_config,
)
from RViT_plus_v11_broadcast.env import ChangeDetectionEnv
from RViT_plus_v11_broadcast.model import RViTPlusV11BroadcastModel
from RViT_plus_v11_broadcast.ppo import PPOConfig, train
...
def main(argv=None) -> int:
    ...
    model = RViTPlusV11BroadcastModel(**model_kwargs).to(device)
    ...
    final_path = os.path.join(args.checkpoint_dir, "rvit_plus_v11_broadcast_rl_final.pt")
