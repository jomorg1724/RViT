...
{
  printf 'experiment=vda4_grid2x2_crossattn1_transformer_memory_2layer_target_tau_1over100_seed0_v1\n'
  printf 'run_root=%s\n' "$RUN_ROOT"
  printf 'target_polyak_tau=0.00005\n'
  printf 'target_ema_decay=0.99995\n'
  printf 'iterations=%s\n' "$ITERS"
