...
for f in test_fsq_quantize.py test_fsq_integration.py test_modern_transformer_memory.py test_softmax_memory_anticollapse.py test_loss_weight_hierarchy.py; do
...
sha256sum \
  ...
  "$PROJECT_ROOT/tests/test_fsq_quantize.py" \
  "$PROJECT_ROOT/tests/test_fsq_integration.py" \
...
{
  printf 'experiment=vda4_modern_fsq2_c1_a01_j0001_lr2e4_s0_v1\n'
  printf 'hypothesis=binary_FSQ_memory_tokens_discretize_representations_stabilize_actor_critic\n'
  printf 'fsq_levels=2\n'
