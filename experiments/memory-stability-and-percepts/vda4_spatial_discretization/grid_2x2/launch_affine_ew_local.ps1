...
$RunName = "vda4_affine_ew_grid2x2_d128_nodecay_seed0_{0}_{1}_{2}" -f $RunTag, $RunStamp, $RunId
...
Write-Host "VDA4 affine 2x2 matched-producer run"
Write-Host "Output: $CheckpointDir"
Write-Host "Iterations: 0..$($Iterations - 1); schedule endpoint: 19999"
