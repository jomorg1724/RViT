...
Usage:
    .venv/bin/python RViT_plus_v7/analysis/avg_attention_maps.py \
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out-dir", default="RViT_plus_v7/analysis/figures")
    ...
    # v7: the attention is the cross-attention block(s), not the LSTM count.
