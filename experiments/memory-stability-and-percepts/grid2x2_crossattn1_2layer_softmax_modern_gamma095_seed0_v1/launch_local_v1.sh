...
cp "$PROJECT_ROOT/tests/test_modern_gamma095_experiment_contract.py" "$RUN_ROOT/provenance/source_snapshot/tests/test_modern_gamma095_experiment_contract.py"
sha256sum \
  ...
  "$PROJECT_ROOT/tests/test_modern_gamma095_experiment_contract.py" \
...
{
  printf 'experiment=vda4_grid2x2_crossattn1_transformer_memory_2layer_softmax_modern_gamma095_seed0_v1\n'
  printf 'run_root=%s\n' "$RUN_ROOT"
  printf 'iterations=%s\n' "$ITERS"
