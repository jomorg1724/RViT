"""RViT+ v11_part4_broadcast — TWO PERFECTLY PARALLEL recurrent cross-attention modules (no
...
HQ←LSTM_Q(ZQ)) feeds the CRITIC. v11_part4_broadcast = v11_part2 with the cross-talk cut: each
...
__all__ = [
    ...
    "DualStreamEncoder",
    "PatchEmbed",
    "RViTPlusV11Part4BroadcastModel",
]
