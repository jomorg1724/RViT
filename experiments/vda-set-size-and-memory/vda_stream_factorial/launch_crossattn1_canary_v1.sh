...
[[ "$SEED" == "0" ]] || { printf 'ERROR: production-v1 canaries are frozen to seed 0\n' >&2; exit 2; }
...
CHECKPOINT_DIR="/workspace/vda4_stream_factorial_crossattn1_visual${VISUAL_STREAMS}_memory${MEMORY_STREAMS}_seed${SEED}_canary_v1_${RUN_STAMP}"
