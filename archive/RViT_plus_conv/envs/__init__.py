...
try:
    ...
    from .tasks import (Validity4Env, VDAEnv, SetSizeEnv, LuoMaunsellEnv, KrauzlisEnv)
except ImportError:  # pragma: no cover
    from base import BaseChangeDetectionEnv  # type: ignore
    from tasks import (Validity4Env, VDAEnv, SetSizeEnv, LuoMaunsellEnv, KrauzlisEnv)  # type: ignore
...
__all__ = ["TASKS", "make_env", "task_grid", "BaseChangeDetectionEnv",
           "Validity4Env", "VDAEnv", "SetSizeEnv", "LuoMaunsellEnv", "KrauzlisEnv"]
