...
Usage:
    .venv/bin/python RViT_plus_v5_part2/analysis/decoder_saliency.py \
...
from RViT_plus_v5_part2.analysis import _behav_utils as bu
from RViT_plus_v5_part2.analysis.avg_attention_maps import (
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--checkpoint", default="RViT_plus_v5_part2/checkpoints/rvit_plus_rl_latest.pt")
    ap.add_argument("--config", default=None)
    ap.add_argument("--out-dir", default="RViT_plus_v5_part2/analysis/figures_decoder")
    ...
    for cond in args.conditions:
        ...
        from RViT_plus_v5_part2.analysis.avg_attention_maps import quad_aggregate
